    ...
    <div class="container">
      <div class="task-list">
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(tarea, index) in tareas" :key="tarea.id" :class="index % 2 === 0 ? 'even' : 'odd'">
              <td>{{ tarea.numOt }}</td>
              <td>{{ tarea.fecha }}</td>
  ...
  export default {
    data() {
      return {
        nuevaTarea: "",
        tareas: [
          { id: 1, numOt: 1, fecha: "02/03/2025", equipoId: 2, nombreEquipo: "Electrocardiografo", averia: "El equipo no imprime y salen artefactos", estado: false },
          ...
          { id: 4, numOt: 4, fecha: "02/03/2025", equipoId: 2, nombreEquipo: "Electrocardiografo", averia: "El equipo no imprime y salen artefactos", estado: false },
        ],
      };
    },
    methods: {
