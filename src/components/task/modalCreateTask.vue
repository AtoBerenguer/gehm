    ...
    <div class="modal">
      <div class="modal-content">
        <h2>Crear tarea</h2>
            ...
            <input type="text" placeholder="Ingrese el número de equipo">
                <hr>
            ...
            <input type="text" placeholder="Ingrese el la descripción de la avería">
                <hr>



            <label for="tecnico_id">Tecnico</label>
            <select v-model="tecnicos" name="" id="">
